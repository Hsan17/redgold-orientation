...
const Hero = () => {
  return (
    <section className="pt-20 pb-10 md:pt-28 md:pb-16 px-4 md:px-8 relative overflow-hidden bg-cream-gradient">
      {/* Background elements */}
      <div className="absolute top-0 left-0 w-full h-full overflow-hidden z-[-1]">
        ...
        <div className="absolute top-1/3 left-1/4 w-24 h-24 bg-burgundy/5 rounded-full blur-xl"></div>
        <div className="absolute bottom-1/4 right-1/3 w-32 h-32 bg-gold/5 rounded-full blur-xl"></div>
      </div>
      ...
      <div className="max-w-6xl mx-auto">
        <div className="flex flex-col lg:flex-row gap-8 items-center">
          ...
          <div className="lg:w-1/2 space-y-4 text-center lg:text-left animate-slide-up">
            <div className="inline-block bg-burgundy/10 text-burgundy-700 px-3 py-1.5 rounded-full font-medium text-sm border border-burgundy-100">
              Trouvez votre voie post-bac avec confiance
            </div>
            <h1 className="text-3xl md:text-4xl lg:text-5xl font-serif font-bold text-burgundy-800 leading-tight">
              Votre avenir commence <span className="text-gradient-burgundy-gold">ici</span>
            </h1>
            ...
            <div className="flex flex-col sm:flex-row gap-3 pt-2 justify-center lg:justify-start">
              <Link to="/orientation" className="btn-primary flex items-center justify-center gap-1 text-base bg-gradient-burgundy">
                Commencer mon orientation <ChevronRight className="h-4 w-4" />
              </Link>
              <Link to="/about" className="btn-outline flex items-center justify-center gap-1 text-base border-duo-gradient">
                En savoir plus
              </Link>
            </div>
          </div>
          ...
          <div className="lg:w-1/2 grid grid-cols-1 sm:grid-cols-2 gap-4 animate-slide-up" style={{ animationDelay: "200ms" }}>
            <div className="glass-card-burgundy rounded-xl p-4 hover:shadow-lg transition-all duration-300 transform hover:-translate-y-1">
            ...
            <div className="glass-card-gold rounded-xl p-4 hover:shadow-lg transition-all duration-300 transform hover:-translate-y-1">
              <School className="h-8 w-8 text-gold-600 mb-3" />
              <h3 className="font-serif font-semibold text-lg text-gold-600 mb-1.5">Universités Recommandées</h3>
              <p className="text-sm text-gray-600">Découvrez les meilleures universités tunisiennes pour votre profil.</p>
            </div>
            
            <div className="glass-card-gold rounded-xl p-4 hover:shadow-lg transition-all duration-300 transform hover:-translate-y-1">
              <BarChart4 className="h-8 w-8 text-gold-600 mb-3" />
              <h3 className="font-serif font-semibold text-lg text-gold-600 mb-1.5">Prédictions d'Emploi</h3>
